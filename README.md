...
### Quantitative results on the TokyoTech and IDH datasets

| Method                                | PSNR ↑     | SSIM ↑    | RMSE ↓   | Delta-E ↓ |
|---------------------------------------|------------|-----------|----------|-----------|
| **TokyoTech**                         |            |           |          |           |
| RVM                                   | 16.53      | 0.62      | **9.12** | 13.43     |
| TLM                                   | 16.33      | 0.64      | 9.26     | 13.67     |
| Ours                                  | **19.30**  | **0.72**  | 9.54     | **10.64** |
|                                       |            |           |          |           |
| **IDH**                               |            |           |          |           |
| RVM                                   | 21.78      | 0.61      | 8.03     | 7.45      |
| TLM                                   | 21.41      | 0.59      | 8.23     | 7.71      |
| Ours                                  | **22.96**  | **0.66**  | **7.87** | **6.38**  |
